...
// acf
  ...
  function cptui_register_my_cpts_apisearch()
  {
      ...
      $labels = [
          "name" => __("apisearch", "twentyeleven"),
          "singular_name" => __("apisearch", "twentyeleven"),
      ];
  
      $args = [
          "label" => __("apisearch", "twentyeleven"),
          "labels" => $labels,
          "description" => "",
          "public" => true,
          ...
          "hierarchical" => false,
          "can_export" => false,
          "rewrite" => [ "slug" => "apisearch", "with_front" => true ],
          "query_var" => true,
          "supports" => [ "title", "editor", "thumbnail" ],
          "show_in_graphql" => false,
      ];
  
      register_post_type("apisearch", $args);
  }
  
  add_action('init', 'cptui_register_my_cpts_apisearch');
/**
...
if (function_exists('acf_add_local_field_group')):
    ...
    acf_add_local_field_group(array(
        'key' => 'group_62611a7969d67',
        'title' => 'apisearch',
        'fields' => array(
            array(
                'key' => 'field_62611a9674b4d',
                'label' => 'name',
                'name' => 'name',
                'type' => 'text',
                'instructions' => '',
