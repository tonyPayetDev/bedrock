...
class Plugin
{
    ...
    public function widget_scripts()
    {
        ...
        wp_enqueue_style('my-custom-styles', esc_url(plugins_url('build/index.css', __FILE__)));
    }
    ...
    public function editor_scripts()
    {
        ...
        //   wp_enqueue_style( 'elementor-hello-world', plugins_url( '/assets/css/toto.css', __FILE__ ), \ElementsKit_Lite::version() );
    ...
    {
        require_once(__DIR__ . '/widgets/search_ktp.php');
    ...
    public function register_widgets()
    {
        ...
        // Register Widgets
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Search_Ktp());
