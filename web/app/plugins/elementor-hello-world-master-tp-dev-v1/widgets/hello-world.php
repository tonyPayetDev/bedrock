...
class Hello_World extends Widget_Base
{
    ...
    protected function render($instance = [])
    {
        ...
        $array = array('type'=>$tab,'url' =>  $settings['ekit_wb_225_url']["url"],'color' =>  $settings['ekit_wb_1860_color'] ,'id' =>2,'visible' => $settings['ekit_biens'], 'visible_search_map' => $settings['ekit_maps']
        );
